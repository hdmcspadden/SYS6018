...
ggplot() + geom_hex(wage, mapping=aes(x=age, y=wage)) + 
  geom_jitter(wage, mapping=aes(x=age, y=wage), shape='.', size=.1, color='green', height=2) +
  #geom_ribbon(data=prediction_interval, fill = "black", alpha = 0.2, mapping=aes(x=age, ymin=lower, ymax=upper)) + 
...
ggplot() + geom_hex(boston, mapping=aes(x=dis, y=nox)) + 
  geom_jitter(boston, mapping=aes(x=dis, y=nox), shape='.', size=1, color='green', height=2) +
...
poly_plot = function(i) {
  ggplot() + geom_hex(boston, mapping=aes(x=dis, y=nox)) + 
  geom_jitter(boston, mapping=aes(x=dis, y=nox), shape='.', size=2, color='green', height=2) +
...
```
**Q9b Observation:**
Not surprising that with the entire data set the residual sum squares decreases as the polynomial increases. I am guessing I am seeing overfitting.
