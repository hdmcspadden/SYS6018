...
```{r qdaCrossValidation, cache=TRUE}
set.seed(1976)
...
<br />
Function  with the additive sqare terms performed better than the simplest model (ClassBinary = Blue), and slightly better than the basic additive model (ClassBinary = Blue + Red + Green).
<br /><br />
