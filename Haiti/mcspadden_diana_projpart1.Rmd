...
```{r logisticTrainingPerf}
caret::confusionMatrix(log.cv.model)
```
<ul>
<li>TPR: 96.6 / 96.8 = 0.998</li>
<li>FPR: 0.3 / 3.2 = 0.094</li>
<li>Precision: 96.6 / 96.9 = 0.997</li>
</ul>
...
```{r logROCTest, include=FALSE, echo=FALSE, eval=FALS}
...
knn.cv.model = train(ClassBinary ~ Blue+Green+Red+GBSqr+RBSqr, data = train, method = "knn", trControl=trctrl, tuneGrid   = expand.grid(k = 11:21))
knn.cv.model
```
...
Tuning parameters for KNN, i.e. the value of k, was selected by using the caret libraries cross validation that also included evaluating the ROC for each cross-validation fold, for a configured range of k. k values were evaluated for 11:21. I selected this range and decided it was valid after reviewing the results. The k value determined to provide the best ROC value was k == 17. Since 17 is is an arbitrary "middle" range of 11 - 21, and because this value produced training AUC-ROC of 1.0, I believe k=17 is an appropriate choice. 
...
<tr>
  ...
  <td><!-- Log Reg Threshold -->1.0</td>
  <td><!-- Log Reg Accuracy -->0.9953</td>
  <td><!-- Log Reg TPR -->0.998</td>
  <td><!-- Log Reg FPR -->0.094</td>
  <td><!-- Log Reg Precision -->0.997</td>
</tr>
...
<tr>
  ...
  <td><!-- LDA Threshold --></td>
  <td><!-- LDA Accuracy -->0.9943</td>
  <td><!-- LDA TPR -->0.999</td>
  <td><!-- LDA FPR -->0.156</td>
  <td><!-- LDA Precision -->0.995</td>
</tr>
...
<tr>
  ...
  <td><!-- QDA AUROC -->1.0</td>
  <td><!-- QDA Threshold --></td>
  <td><!-- QDA Accuracy -->0.9945</td>
  <td><!-- QDA TPR -->0.998</td>
  <td><!-- QDA FPR -->0.094</td>
  <td><!-- QDA Precision -->0.997</td>
</tr>

<tr>
  <td>KNN</td>
  <td><!-- KNN Tuning --> k = 17</td>
  <td><!-- KNN AUROC -->1.0</td>
  <td><!-- KNN Threshold --></td>
...
<tr>
  ...
  <td><!-- Penalized Log Reg Tuning --> k = </td>
