...
haitiBinaryFull = haitiBinarySqrs %>%
  ...
  mutate(Red = scale(Red), Blue = scale(Blue), Green = scale(Green), GBSqr = scale(GBSqr), RBSqr = scale(RBSqr), RGSqr = scale(RGSqr), RGBSqr = scale(RGBSqr))
```
...
log.cv.model = train(ClassBinary~Blue+Green+Red+GBSqr+RBSqr+RGSqr+RGBSqr, data = haitiBinaryFull, method = "glmnet", trControl=trctrl, tuneLength = 10)
log.cv.model
```
...
set.seed(825)
log.pen.cv.model <- train(ClassBinary ~ Blue+Green+Red+GBSqr+RBSqr+RGSqr+RGBSqr, data = train, 
                  method = "glmnet",
                  metric = "ROC",
                  tuneLength = 10,
                  trControl = trctrl)
