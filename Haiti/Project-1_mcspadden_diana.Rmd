...
out_lr_test_spec
```
The AUC for thresholds 0.1, 0.2, 0.3, 0.4, and 0.5 are identical, so I will stick with the threshold selected using the training data of **0.1**.
...
**0.2** provides MUCH better True Positive Rate predictive power on the holdout data than 0.8. I will use 0.2 for the confusion matrix and ROC.
...
For LDA, the hold-out test results with the tuned threshold of 0.2 are:

<ul>
<li>Accuracy: 0.9849</li>
<li>TPR: 13313 / (14480) = 0.919</li>
<li>FPR: 29120 / (1989697) = 0.015</li>
<li>Precision: 0.3137</li>
</ul>
...
Using the holdout data the best threshold for the QDA model is **0.2**.
...
<li>TPR: 6096 / (14480) = 0.421</li>
<li>FPR: 30960 / (1989697) = 0.016</li>
<li>Precision: 0.1645</li>
</ul>
...
<ul>
<li>Accuracy: 0.9937</li>
<li>TPR: 8520 / (14480) = 0.588</li>
<li>FPR: 6755 / (1989697) = 0.003</li>
<li>Precision: 0.5578</li>
</ul>
...
<ul>
<li>Accuracy: 0.9895</li>
<li>**TPR: 14377 / (14480) = 0.993**</li>
<li>FPR: 20946 / (1989697) = 0.01</li>
<li>Precision: 0.41</li>
</ul>
...
<tr>
  ...
  <td><!-- LDA Threshold -->0.2</td>
  <td><!-- LDA Accuracy -->0.9849</td>
  <td><!-- LDA TPR -->0.919</td>
  <td><!-- LDA FPR -->0.015</td>
  <td><!-- LDA Precision -->0.3137</td>
</tr>
...
<tr>
  ...
  <td><!-- QDA Threshold -->0.2</td>
  <td><!-- QDA Accuracy -->0.9804</td>
  <td><!-- QDA TPR -->0.421</td>
  <td><!-- QDA FPR -->0.016</td>
  <td><!-- QDA Precision -->0.1645</td>
</tr>
...
<tr>
  ...
  <td><!-- Random Forest Threshold -->0.6</td>
  <td><!-- Random Forest Accuracy -->0.9937</td>
  <td><!-- Random Forest TPR -->0.588</td>
  <td><!-- Random Forest FPR -->0.003</td>
  <td><!-- Random Forest Precision -->0.5578</td>
</tr>

<tr>
  <td>SVM</td>
  <td><!-- SVM Tuning --> linear kernel, cost == 1</td>
  <td><!-- SVM AUROC -->0.999</td>
  <td><!-- SVM Threshold -->0.2</td>
  <td><!-- SVM Accuracy -->0.9895</td>
  <td><!-- SVM TPR -->0.993</td>
  <td><!-- SVM FPR -->0.01</td>
  <td><!-- SVM Precision -->0.41</td>
</tr>
</table>
